...
Enumerate the supported AI agent CLIs (Claude Code, GitHub Copilot), surface their on-disk configuration paths and detection status, and expose API token configuration used when fetching marketplace data.
