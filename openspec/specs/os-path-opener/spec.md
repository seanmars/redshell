...
Provide a Wails-bound capability that opens filesystem paths (files or directories) in the host operating system's default handler, with tilde expansion and explicit error reporting for missing targets.
